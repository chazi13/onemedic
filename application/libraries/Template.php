...
class Template {
	...
	public function get_template_data()
	{
		...
		if (!empty($this->title))
			$template_data['base_title'] = $this->title . $this->title_separator . $template_data['title'];
	...
	public function build($view, $data = array(), $output = FALSE)
	{
		...
		$data['template'] = $this->get_template_data();
	...
	public function build_layout($layout, $view, $data = array(), $output = FALSE)
	{
		// Save to view variable.
		$data['template'] = $this->get_template_data();
		...
		// Apply content to child layout, replace content.
		$data['template']['content'] = $this->ci->load->view($this->layout_path . '/' . $layout, $data, true);
