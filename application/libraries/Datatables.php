...
class Datatables
{
	...
	private function get_total_results($filtering = false)
	{
		...
		if (strlen($this->distinct) > 0) {
			...
			$this->ci->db->select($this->select_src, $this->backtick_protect);
		}
	...
	/**
	 * Returns if a field is exists
	 * @return boolean
	 */
	public function field_exists($field_name, $table_name)
	{
		return $this->ci->db->field_exists($field_name, $table_name);
	}
}
