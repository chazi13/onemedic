...
|
*/
$config['template']['base_title'] = 'One Medic';
...
$config['template']['metas'] = array(
	'description'	=> 'One Medic Personal Doctor Assistant Application',
...
|
*/
$config['template']['js_header'] = array('plugins/bootstrap-notify/bootstrap-notify');
