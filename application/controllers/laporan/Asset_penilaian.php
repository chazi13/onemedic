...
class Asset_penilaian extends Admin_Controller {
    ...
    function datatables_sourcedata() {
        ...
        $this->datatables
                ->select("kode, nama, merk_nama, tipe_nama, asset_penilaian.tanggal AS tanggal_penilaian, asset_penilaian.harga_penilaian", FALSE)
                ->join('asset_penilaian', 'asset_penilaian.barang_id = asset_inventarisasi.id')
