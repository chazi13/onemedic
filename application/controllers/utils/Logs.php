...
class Logs extends Admin_Controller
{
	...
	function message()
	{
		$this->load->vars('panel_title', 'Message Hook');

		$this->_display_log('message');
	}

	function autorecon()
	{
		$this->load->vars('panel_title', 'Autorecon');

		$this->_display_log('autorecon');
	}
	...
	function _display_log($mode)
	{
		...
		Date::setLocale($this->session->userdata('lang'));
		$log_files = array();
		if (is_dir($log_path)) {
