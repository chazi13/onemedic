										...
										<a href="<?php echo (isset($nav['uri']) ? site_url($nav['uri']) : 'javascript:;') ?>" class="m-menu__link ">
											...
											<span class="m-menu__link-title">
												<span class="m-menu__link-wrap"> 
													<span class="m-menu__link-text"><?php echo $nav['title'] ?>....</span>
													</span>
												</span>
											</span>
										</a>
				...
				<div class="page-header-content header-elements-md-inline">
					...
					<div class="header-elements d-none">
						<div class="d-flex justify-content-center">
							<a href="<?php echo site_url('master/farmasi') ?>" class="btn btn-link btn-float text-default"><i class="icon-calendar5 text-primary"></i> <span>Obat</span></a>
						</div>
					</div>
				</div>
