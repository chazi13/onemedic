			...
			<ul class="navbar-nav">
				<li class="nav-item dropdown">
					<a href="#" class="navbar-nav-link dropdown-toggle caret-0" data-toggle="dropdown">
						...
						<span class="badge badge-pill bg-warning-400 ml-auto ml-md-0">5</span>
					</a>
							...
							<ul class="media-list">
								<li class="media">
									...
									<div class="media-body">
										<a href="#" class="media-title font-weight-semibold">Agus Rahmat Hidayat</a>
										<span class="d-block text-muted font-size-sm">Pendaftaran</span>
									</div>
								</li>
								...
								<li class="media">
									...
									<div class="media-body">
										<a href="#" class="media-title font-weight-semibold">Anisa Sulistiawati</a>
										<span class="d-block text-muted font-size-sm">Pendaftaran</span>
									</div>
								</li>
								...
								<li class="media">
									...
									<div class="media-body">
										<a href="#" class="media-title font-weight-semibold">Anna Widya Ningsih</a>
										<span class="d-block text-muted font-size-sm">Apotek</span>
									</div>
								</li>
								...
								<li class="media">
									...
									<div class="media-body">
										<a href="#" class="media-title font-weight-semibold">Marina Sulstiawati</a>
										<span class="d-block text-muted font-size-sm">Apotek</span>
									</div>
								</li>
								...
								<li class="media">
									...
									<div class="media-body">
										<a href="#" class="media-title font-weight-semibold">Gun Gun Yanwar</a>
										<span class="d-block text-muted font-size-sm">Keuangan</span>
									</div>
								</li>
							</ul>
						</div>
				...
				<div class="page-header-content header-elements-md-inline">
					...
					<!-- <div class="header-elements d-none">
						<div class="d-flex justify-content-center">
							<a href="#" class="btn btn-link btn-float text-default"><i class="icon-file-excel text-primary"></i><span>Download</span></a>
							<a href="#" class="btn btn-link btn-float text-default"><i class="icon-printer2 text-primary"></i> <span>Cetak</span></a>
						</div>
					</div> -->
				</div>
