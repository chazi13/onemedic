    ...
    <div class="card-body">
        <form class="form-horizontal" method="post" action="" id="filter-pasien">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-3">
                    <?php echo form_dropdown('tipe_pasien', $optionTipePasien, '', 'id="tipe_pasien" class="form-control"'); ?>
                </div>
            </div>
        </form>
        <hr/>
...
<script>
    $(function() {
        ...
        var dataTables = $('#report-table').DataTable({
                        ...
                        "ajax": {
                            'type': 'POST',
                            'url': '<?php echo site_url("laporan/pendaftaran_rwj/datatables")?>',
        ...
        $("#tgl_awal_show, #tgl_akhir_show, #poli, #dokter, #tipe_pasien").on('change', function() {
