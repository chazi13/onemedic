...
<div class="card">
    ...
    <div class="card-body">
        <form method="post" action="">
            ...
            <div class="col-lg-12">
                <div class="form-group row">
                    <label class="col-lg-1 control-label">Rawatan</label>
                    <div class="col-lg-4">
                        <?php echo form_dropdown('rawatan',array('rwj' => 'Rawat Jalan', 'rwi' => 'Rawat Inap'), '', ' id="rawatan" class="form-control"'); ?>
                    </div>
            ...
            <table class="display table table-bordered table-striped" id="report-table">
                <thead>
                    <tr>
                        ...
                        <td class="text-center">No. Resep</td>
                        <td class="text-center">Dokter</td>
                        <td class="text-center">No.Reg</td>
                        <td class="text-center">No.MR</td>
...
<script>
    $(function() {
        ...
        var dataTables = $('#report-table').DataTable({
                        ...
                        "ajax": {
                            'type': 'POST',
                            'url': '<?php echo site_url("laporan/apotek_narkotika_psikotropika/datatables")?>',
                            'data': function(params)  {
                                    params.tanggal_awal = $('#tanggal_awal').val();
                                    params.tanggal_akhir = $('#tanggal_akhir').val();
                                    params.shift = $('#rawatan').val();
