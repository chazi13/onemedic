...
<div class="card">
    ...
    <div class="card-body">
        <form class="form-horizontal" method="post" action="" id="filter-pasien">
            ...
            <div class="form-group row">
                <label class="col-lg-2 control-label">Apotek / Depo (Dari)</label>
                <div class="col-lg-4">
                    <?php echo form_dropdown('apotek_id_dari', $optionsApotekDari, '', 'id="apotek_id_dari" class="form-control"'); ?>
                </div>
                <label class="col-lg-2 control-label">Apotek / Depo (Ke)</label>
                <div class="col-lg-4">
                    <?php echo form_dropdown('apotek_id_ke', $optionsApotekKe, '', 'id="apotek_id_ke" class="form-control"'); ?>
                </div>
            </div>
        </form>
        <hr/>
        <div class="table-responsive">
            <table class="display table table-bordered table-striped" id="report-table">
                <thead>
                    <tr>
                        <td class="text-center" >Apotek</td>
                        <td class="text-center" >Tanggal</td>
                        <td class="text-center" >Dari</td>
                        <td class="text-center" >Ke</td>
                        <td class="text-center" >Jumlah Item</td>
...
<script>
    $(function() {
        ...
        var dataTables = $('#report-table').DataTable({
                        ...
                        "ajax": {
                            'type': 'POST',
                            'url': '<?php echo site_url("laporan/inv_internal_transfer/datatables")?>',
