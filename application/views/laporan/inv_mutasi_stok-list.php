    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="display table table-bordered table-striped" id="report-table">
                <thead>
                    <tr>
                        <td class="text-center" rowspan="2" style="vertical-align: middle;">Tanggal</td>
                        <td class="text-center" colspan="3">Masuk</td>
                        <td class="text-center" colspan="3">Keluar</td>
                        <td class="text-center" colspan="3">Retur Masuk</td>
                        <td class="text-center" colspan="3">Retur Keluar</td>
                        <td class="text-center" colspan="3">Saldo</td>
                        <td class="text-center" rowspan="2" style="vertical-align: middle;">Keterangan</td>
                    </tr>
                    <tr>
                        <td>Qty</td>
                        <td>Harga</td>
...
<script>
    $(function() {
        ...
        var dataTables = $('#report-table').DataTable({
                        ...
                        "ajax": {
                            'type': 'POST',
                            'url': '<?php echo site_url("laporan/inv_mutasi_stok/datatables")?>',
