...
<div class="card">
    <div class="card-body">
        ...
        <table class="display table table-bordered table-striped" id="lap-penghapusan">
            <thead>
                <tr>
                    <th style="width:170px;">Tgl. Penghapusan</th>
...
<script>
    $(function() {
        ...
        var dataTables = $("#lap-penghapusan").DataTable({
            "processing": true,
            "serverSide": true,
            ...
            "info": false,
            "ajax": {
                "url": "<?php echo site_url('laporan/asset_penghapusan/datatables_sourcedata') ?>",
                "type": "POST",
                "data": function(d) {
        ...
        $('select[name="unit_id"], select[name="jenis_barang_id"], select[name="lokasi_barang_id"], input[name="tgl_awal_show"], input[name="tgl_akhir_show"]').on('change', function() {
            dataTables.draw();
        });
    });
</script>
